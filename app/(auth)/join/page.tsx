        ...
        <section>
          <form action="" onSubmit={join}>
            <div className="input_box">
              ...
              <Box mt="3" className="row">
                <Text as="label" weight="medium" htmlFor="user_cls">클래스</Text>
                <Flex mt="2" justify="start" align="center" direction="row" gap="30px" gapY="10px" wrap="wrap" className="radio_box" asChild>
                  <RadioGroup.Root defaultValue="ai" name="user_cls" size="3">
                    <RadioGroup.Item id="user_cls_ai" value="ai">AI 엔지니어링</RadioGroup.Item>
                    <RadioGroup.Item id="user_cls_cloud" value="cloud">클라우드 엔지니어링</RadioGroup.Item>
                    <RadioGroup.Item id="user_cls_service" value="service">클라우드 서비스 개발</RadioGroup.Item>
                  </RadioGroup.Root>
                </Flex>
              </Box>
            </div>
